...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adaptador2 =
                new ArrayAdapter<>(this,android.R.layout.simple_spinner_item,UbicacionS);
...
//     if(fila.moveToFirst()){
    ...
    public void EliminarProducto(View view){
        ...
        if (!IDProducto.isEmpty()){
            ...
            if (Eliminar == 1){
                Toast.makeText(this, "Se a eliminado correctamente =)", Toast.LENGTH_SHORT).show();
                ID.setText("");
                Nombre.setText("");
                Categoria.setSelection(0);
                Cantidad.setText("");
     ...
     //   Integer cantidad = Integer.parseInt(Cantidad.getText().toString());
       // Integer precio = Integer.parseInt(Precio.getText().toString());
        ...
        if (!IDproducto.isEmpty() && !NombreProducto.isEmpty() && !CategoriaS.equals("Seleccione:") && !cantidad.equals("") && !precio.equals("") && !ubicacion.equals("Seleccione:")){
            ...
            if (Update == 1) {
                Toast.makeText(this, "Se a Actualizado correctamente", Toast.LENGTH_SHORT).show();
                ID.setText("");
                Nombre.setText("");
                Categoria.setSelection(0);
                Cantidad.setText("");
                ...
                Toast.makeText(this, "No se a encontrado esa ID", Toast.LENGTH_SHORT).show();
            }
        } else {
